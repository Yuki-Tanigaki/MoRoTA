...
from morota.opt.evaluation import ExpectedMakespanEvaluator, OutsidePathEvaluator
from morota.sim.agent import WorkerAgent, TaskAgent
from morota.sim.task_selection.task_selector import TaskSelector
from morota.opt.representation import Individual
from morota.opt.ga_core import SimpleGA
from morota.utils.logging_utils import get_logger
...
class GABasedTaskSelector(TaskSelector):
    ...
    # --------------------------------------------------
    def _ensure_plan(self, model: morotaScenarioModel) -> None:
        """
    ...
    # --------------------------------------------------
    def assign_tasks(self, model: morotaScenarioModel) -> None:
        # --- GA 計画を用意 ---
